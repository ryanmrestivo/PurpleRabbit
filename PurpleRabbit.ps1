...
if ($option -eq "exit"){ exit }
    ...
    Option 19: Scan Gateway                             Option 25: PSpanner - Network Scanner               
...
if ($option -eq "az2"){
 ...
 Write-Host " [*] Running Through Subscriptions ... " -ForegroundColor Green
    ...
    if ($option -eq "25"){powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSpanner/master/PSpanner.ps1')"}
    if ($option -eq "26"){powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSdnsresolver/master/PSdnsresolver.ps1')"}
    if ($option -eq "27"){powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/Bluechecker/master/Bluechecker.ps1')"}
    if ($option -eq "28"){powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSBruteZip/master/PSBruteZip.ps1')"}
   ...
   if ($option -eq "30"){
    ...
    if ($option -eq "32"){[System.Security.Principal.WindowsIdentity]::GetCurrent()}
...
"Firewall		5025	The Windows Firewall Service has been stopped")
	...
	if ($option -eq "50") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSBruteZip/master/PSBruteZip.ps1')" }
	if ($option -eq "51") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSdnsresolver/master/PSdnsresolver.ps1')" }
	if ($option -eq "52") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/Bluechecker/master/Bluechecker.ps1')" }
	if ($option -eq "53") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSBruteZip/master/PSBruteZip.ps1')" }
	if ($option -eq "54") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSBruteZip/master/PSBruteZip.ps1')" }
	if ($option -eq "55") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSdnsresolver/master/PSdnsresolver.ps1')" }
	if ($option -eq "56") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/Bluechecker/master/Bluechecker.ps1')" }
	if ($option -eq "57") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSBruteZip/master/PSBruteZip.ps1')" }
	if ($option -eq "58") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSBruteZip/master/PSBruteZip.ps1')" }
	if ($option -eq "59") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/PSdnsresolver/master/PSdnsresolver.ps1')" }
	if ($option -eq "60") { powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/securethelogs/Bluechecker/master/Bluechecker.ps1')" }
